...
static func _strip_dur(lines: Array) -> Array:
	var out: Array = []
	for l in lines:
		out.append({ "name": l["name"], "text": l["text"], "vid": l.get("vid", "") })
	return out
...
static func chapters() -> Array[Dictionary]:
	...
	out.append({
		...
		"cutscene": {
			...
			"intro": [
				{ "name": "陈振国上校", "text": "零度行动开始。白狼一夜扫平边境六处要地——你们脚下的街区,是最后一块。夺回来,城就回来了。", "dur": 3.6, "vid": "c1_intro_chen_01" },
				{ "name": "苏雅", "text": "链路恢复。路口有火力点,主街沿线都有伏击位,别走直线,听我实时播报。", "dur": 3.2, "vid": "c1_intro_suya_01" },
				{ "name": "白狼", "text": "齐万里在首哨把命留给了我们。雪豹小队,想听他的遗言,就到主街来。", "dur": 3.4, "vid": "c1_intro_wolf_01" },
				{ "name": "曹锐", "text": "……齐排长的遗言,我自己去听。铁柱、林雪,主街跟我;老周,高点,把路口清出来。", "dur": 3.4, "vid": "c1_intro_caorui_01" },
				{ "name": "老周", "text": "风不大,视野正好。队长,别让他牵着走——我们打我们的。", "dur": 3.0, "vid": "c1_intro_laozhou_01" },
			],
			"outro": [
				{ "name": "林雪", "text": "街区肃清,无平民滞留。白狼撤得很干净,把能搬的都搬空了。", "dur": 3.6, "vid": "c1_outro_linxue_01" },
				{ "name": "苏雅", "text": "他留了段电文:『这是开场,不是尾声。』信号是跳频的,追不到。", "dur": 3.4, "vid": "c1_outro_suya_01" },
				{ "name": "陈振国上校", "text": "夺路完成。城空的账先记下——雪豹小队,向沙漠油站机动,补给队随后到。", "dur": 3.6, "vid": "c1_outro_chen_01" },
				{ "name": "曹锐", "text": "他炸得掉城,炸不掉家。走,一处处夺回来。", "dur": 3.0, "vid": "c1_outro_caorui_01" },
			],
		...
		"mid_lines": [
			{ "name": "老周", "text": "路口清了一半,火力点都在后撤,别追太深,留人盯主街。", "dur": 3.2, "vid": "c1_mid_laozhou_01" },
			{ "name": "林雪", "text": "负伤的往我这边靠,医疗包管够。", "dur": 2.6, "vid": "c1_mid_linxue_01" },
			{ "name": "苏雅", "text": "西区路口守敌折损过半,广场方向有增援,小心身后。", "dur": 3.2, "vid": "c1_mid_suya_01" },
		],
		"finish_lines": [
			{ "name": "曹锐", "text": "路通了,老周,高点把路口清出来!", "dur": 2.8, "vid": "c1_finish_caorui_01" },
			{ "name": "铁柱", "text": "检查站到手,广场方向没有重火力,走!", "dur": 2.8, "vid": "c1_finish_tiezhu_01" },
		],
	})
	...
	out.append({
		...
		"cutscene": {
			...
			"intro": [
				{ "name": "陈振国上校", "text": "白狼在油站布了爆破网,要炸掉整座油库。补给线断三个月,前线的仗就不用打了。", "dur": 3.6, "vid": "c2_intro_chen_01" },
				{ "name": "苏雅", "text": "无人机侦察:外围四座机枪台,雷区在输油管线两侧,站内有布防小组,人数不明。", "dur": 3.4, "vid": "c2_intro_suya_01" },
				{ "name": "曹锐", "text": "铁柱,爆破网怎么拆,你最有数。", "dur": 2.8, "vid": "c2_intro_caorui_01" },
				{ "name": "铁柱", "text": "他们埋得快,接线图八成在站长室。先进站抢图纸,再拆雷,一锅端。", "dur": 3.2, "vid": "c2_intro_tiezhu_01" },
				{ "name": "曹锐", "text": "老周,机枪台点掉;林雪跟我进站。苏雅,全程报数,听我口令断站区电。", "dur": 3.2, "vid": "c2_intro_caorui_02" },
			],
			"outro": [
				{ "name": "铁柱", "text": "爆破网全拆,一根引线没剩。图纸还顺出两张——他们布的不止这一座站。", "dur": 3.6, "vid": "c2_outro_tiezhu_01" },
				{ "name": "苏雅", "text": "图纸解析完成:六处要地都有兵力表,还多了一支预备队,代号『北翼』,正往雪山方向集结。", "dur": 3.8, "vid": "c2_outro_suya_01" },
				{ "name": "陈振国上校", "text": "补给线通了。『北翼』……雪山哨站的侦察班正在追它,信号三小时前断了。", "dur": 3.6, "vid": "c2_outro_chen_01" },
				{ "name": "曹锐", "text": "侦察班,是老周送过去的那支?", "dur": 2.6, "vid": "c2_outro_caorui_01" },
				{ "name": "老周", "text": "……是我送他们去的。队我来带,人我去接。", "dur": 3.0, "vid": "c2_outro_laozhou_01" },
			],
		...
		"mid_lines": [
			{ "name": "铁柱", "text": "机枪台哑了两座,站区布防组在收缩,稳着打。", "dur": 3.0, "vid": "c2_mid_tiezhu_01" },
			{ "name": "苏雅", "text": "油站守敌折损过半,注意输油管两侧的雷区。", "dur": 3.0, "vid": "c2_mid_suya_01" },
			{ "name": "老周", "text": "主站方向有狙击手,进站前先把制高点压住。", "dur": 3.0, "vid": "c2_mid_laozhou_01" },
		],
		"finish_lines": [
			{ "name": "铁柱", "text": "接线图到手,爆破网有解了!", "dur": 2.6, "vid": "c2_finish_tiezhu_01" },
			{ "name": "苏雅", "text": "油库控制权到手,补给线稳了。", "dur": 2.8, "vid": "c2_finish_suya_01" },
		],
	})
	...
	out.append({
		...
		"cutscene": {
			...
			"intro": [
				{ "name": "苏雅", "text": "『北翼』把侦察班围在雪山哨站。暴风雪三小时后封山,信号已断,他们撑不了太久。", "dur": 3.6, "vid": "c3_intro_suya_01" },
				{ "name": "陈振国上校", "text": "侦察班带着『北翼』的完整部署,人也都是好兵。曹锐,带他们回来,一个不少。", "dur": 3.6, "vid": "c3_intro_chen_01" },
				{ "name": "老周", "text": "东南山脊能架枪,风大,我贴地进,快不了。", "dur": 3.0, "vid": "c3_intro_laozhou_01" },
				{ "name": "曹锐", "text": "老周,你不是一个人去。铁柱,谷口留撤出通道;林雪,血包带足,雪地里时间就是命。", "dur": 3.4, "vid": "c3_intro_caorui_01" },
				{ "name": "老周", "text": "……孟海是我送进侦察班的。他要是少一根头发,我这辈子过不去。", "dur": 3.2, "vid": "c3_intro_laozhou_02" },
			],
			"outro": [
				{ "name": "林雪", "text": "两名幸存者,伤情稳定。孟海左臂骨折,命保住了。", "dur": 3.2, "vid": "c3_outro_linxue_01" },
				{ "name": "老周", "text": "……活着就好。方志走前托我带话给他弟弟:『别学我,该活着的时候,得活着。』", "dur": 3.8, "vid": "c3_outro_laozhou_01" },
				{ "name": "苏雅", "text": "孟海交出了完整部署图:白狼指挥部——暗夜雷达站,防空指挥雷达,他本人坐镇。", "dur": 3.8, "vid": "c3_outro_suya_01" },
				{ "name": "陈振国上校", "text": "人和情报都到手,『北翼』失了先手。接下来,轮到我们进攻了。", "dur": 3.4, "vid": "c3_outro_chen_01" },
				{ "name": "曹锐", "text": "雪会化,冰会碎,兄弟不会。老周,把方志的话捎到了,你也该下山了。", "dur": 3.4, "vid": "c3_outro_caorui_01" },
			],
		...
		"mid_lines": [
			{ "name": "老周", "text": "山脊压住一片,哨站方向还有两处火力点,贴着雪走。", "dur": 3.2, "vid": "c3_mid_laozhou_01" },
			{ "name": "林雪", "text": "雪地里别恋战,孟海还等着我们,保命优先。", "dur": 3.0, "vid": "c3_mid_linxue_01" },
			{ "name": "苏雅", "text": "哨站守敌折损过半,侦察班的撤离窗口在打开。", "dur": 3.0, "vid": "c3_mid_suya_01" },
		],
		"finish_lines": [
			{ "name": "老周", "text": "……孟海,还活着。谢天谢地。", "dur": 2.8, "vid": "c3_finish_laozhou_01" },
			{ "name": "林雪", "text": "幸存者都在,撤出路线干净,快走!", "dur": 2.8, "vid": "c3_finish_linxue_01" },
			{ "name": "曹锐", "text": "哨站拿回来了,一个不少,撤!", "dur": 2.6, "vid": "c3_finish_caorui_01" },
		],
	})
	...
	out.append({
		...
		"cutscene": {
			...
			"intro": [
				{ "name": "陈振国上校", "text": "河谷是白狼的纵深防线,对岸囤着西线全部弹药。重装部队过不了河,反攻就是空话。", "dur": 3.6, "vid": "c4_intro_chen_01" },
				{ "name": "苏雅", "text": "水位两天涨了半米,两座便桥都在他火力走廊里。强攻,会死人。", "dur": 3.2, "vid": "c4_intro_suya_01" },
				{ "name": "曹锐", "text": "先拔弹药库,再抢桥头。铁柱,爆破组跟我走水线;老周,对岸机枪阵地,一个不留。", "dur": 3.4, "vid": "c4_intro_caorui_01" },
				{ "name": "铁柱", "text": "水线……行,我带足防水炸药。先说好,炸过头了,别怪我发明了新河道。", "dur": 3.4, "vid": "c4_intro_tiezhu_01" },
				{ "name": "老周", "text": "水声吞枪声。过河的时候,谁也别回头。", "dur": 2.8, "vid": "c4_intro_laozhou_01" },
			],
			"outro": [
				{ "name": "铁柱", "text": "弹药库炸了,殉爆掀翻对岸半条防线。……小马,没回来。", "dur": 3.2, "vid": "c4_outro_tiezhu_01" },
				{ "name": "曹锐", "text": "过河的命令是我下的,水位也是我判的。这笔账,我认。", "dur": 3.0, "vid": "c4_outro_caorui_01" },
				{ "name": "老周", "text": "认账的不叫指挥官,少欠一条命的才叫。账记着,去下一个渡口还。", "dur": 3.2, "vid": "c4_outro_laozhou_01" },
				{ "name": "苏雅", "text": "重装部队过河了。侦察机报告:暮港码头灯火通明,白狼的船队在连夜装货。", "dur": 3.4, "vid": "c4_outro_suya_01" },
				{ "name": "曹锐", "text": "那我们就连夜去拆他的货。还账的最好方式,是让敌人先欠。", "dur": 3.0, "vid": "c4_outro_caorui_02" },
			],
		...
		"mid_lines": [
			{ "name": "铁柱", "text": "对岸机枪阵地在换弹间歇,趁这个窗口推进。", "dur": 3.0, "vid": "c4_mid_tiezhu_01" },
			{ "name": "苏雅", "text": "河谷守军折损过半,渡口火力在减弱。", "dur": 2.8, "vid": "c4_mid_suya_01" },
			{ "name": "老周", "text": "水声吞枪声,过河的时候,谁也别回头。", "dur": 2.8, "vid": "c4_mid_laozhou_01" },
		],
		"finish_lines": [
			{ "name": "铁柱", "text": "弹药库殉爆,渡口方向干净了!", "dur": 2.8, "vid": "c4_finish_tiezhu_01" },
			{ "name": "苏雅", "text": "桥头堡到手,工兵可以进场架桥了。", "dur": 2.8, "vid": "c4_finish_suya_01" },
		],
	})
	...
	out.append({
		...
		"cutscene": {
			...
			"intro": [
				{ "name": "苏雅", "text": "暮港码头,白狼最后的补给线。船在装货,货在仓库,天亮前全走,就再没机会。", "dur": 3.6, "vid": "c5_intro_suya_01" },
				{ "name": "陈振国上校", "text": "断他海上补给,困他在陆上。补给船、起重设备、仓库,一个不留。", "dur": 3.2, "vid": "c5_intro_chen_01" },
				{ "name": "曹锐", "text": "铁柱,爆破组跟我走栈桥;老周,塔吊上压全港火力;林雪,货场入口留道缝接应。", "dur": 3.4, "vid": "c5_intro_caorui_01" },
				{ "name": "铁柱", "text": "老周,你那是居高临下,我这叫高空作业——别把塔吊打塌,我还指着它吊炸药。", "dur": 3.4, "vid": "c5_intro_tiezhu_01" },
				{ "name": "老周", "text": "我不炸塔吊。塔吊顶上那盏灯,今晚正好当瞄准镜。", "dur": 3.0, "vid": "c5_intro_laozhou_01" },
			],
			"outro": [
				{ "name": "铁柱", "text": "船沉了,仓烧了……嘶,埋在桶里的炸药,专门等着我,真他娘讲究。", "dur": 3.4, "vid": "c5_outro_tiezhu_01" },
				{ "name": "林雪", "text": "弹片在右肩,位置不好,别动。队长,白狼刚就在塔吊影子里——他是故意放我们进来的。", "dur": 3.6, "vid": "c5_outro_linxue_01" },
				{ "name": "曹锐", "text": "林雪,带铁柱撤出去,码头的事完了。白狼往北跑了——今天的账先记着,兄弟不能折在今晚。", "dur": 3.8, "vid": "c5_outro_caorui_01" },
				{ "name": "苏雅", "text": "指挥部复述白狼电文:『雪豹小队,我在雷达站等你们,来把故事讲完。』", "dur": 3.4, "vid": "c5_outro_suya_01" },
				{ "name": "曹锐", "text": "讲完就讲完。铁柱的伤,我记在雷达站的账上——最后一枪,我要亲眼看着打出去。", "dur": 3.4, "vid": "c5_outro_caorui_02" },
			],
		...
		"mid_lines": [
			{ "name": "老周", "text": "塔吊上看得清楚,码头守军往仓库带撤了。", "dur": 3.0, "vid": "c5_mid_laozhou_01" },
			{ "name": "林雪", "text": "栈桥火力点拔掉大半,货场入口还留着缝。", "dur": 3.0, "vid": "c5_mid_linxue_01" },
			{ "name": "苏雅", "text": "码头守军折损过半,白狼的船还在装货,动作快。", "dur": 3.0, "vid": "c5_mid_suya_01" },
		],
		"finish_lines": [
			{ "name": "铁柱", "text": "炸药埋好了,船在劫难逃。", "dur": 2.6, "vid": "c5_finish_tiezhu_01" },
			{ "name": "林雪", "text": "撤离点清出来了,兄弟们撤!", "dur": 2.8, "vid": "c5_finish_linxue_01" },
		],
	})
	...
	out.append({
		...
		"cutscene": {
			...
			"intro": [
				{ "name": "苏雅", "text": "暗夜雷达站,防空指挥雷达,白狼最后的堡垒。雷达在,他们的炮火就长着眼睛。", "dur": 3.6, "vid": "c6_intro_suya_01" },
				{ "name": "陈振国上校", "text": "零度行动,终章。六处要地,五处已经回来,这是最后一处。雪豹小队,你们是整个战役的矛尖。", "dur": 3.8, "vid": "c6_intro_chen_01" },
				{ "name": "曹锐", "text": "从街区到油站,从雪山到河谷,再到今晚的港口——我们一路打过来,不是因为枪好,是因为身边有人。", "dur": 3.8, "vid": "c6_intro_caorui_01" },
				{ "name": "老周", "text": "山顶风大信号差。狙击位我自己找,你们放心往上打。", "dur": 3.0, "vid": "c6_intro_laozhou_01" },
				{ "name": "林雪", "text": "打完这一仗,我请全队喝热汤。规矩不变——先活着,再喝汤。", "dur": 3.0, "vid": "c6_intro_linxue_01" },
			],
			"outro": [
				{ "name": "白狼", "text": "……齐万里临死前说,会有人替他打完这一仗。看来,他赌对了。", "dur": 3.6, "vid": "c6_outro_wolf_01" },
				{ "name": "曹锐", "text": "雷达站收复,白狼确认死亡。零度行动,任务完成。", "dur": 3.2, "vid": "c6_outro_caorui_01" },
				{ "name": "苏雅", "text": "指挥部全体频道:边境六处要地全部收复,防线回到联军手中。", "dur": 3.4, "vid": "c6_outro_suya_01" },
				{ "name": "陈振国上校", "text": "雪豹小队,干得漂亮。从今天起,你们的名字,就是联军的旗帜。", "dur": 3.2, "vid": "c6_outro_chen_01" },
				{ "name": "曹锐", "text": "齐排长,首哨的灯,我替你点回来了。……全体,回家。", "dur": 3.4, "vid": "c6_outro_caorui_02" },
			],
		...
		"mid_lines": [
			{ "name": "苏雅", "text": "雷达站守军折损过半,白狼的贴身卫队还没动。", "dur": 3.0, "vid": "c6_mid_suya_01" },
			{ "name": "老周", "text": "山顶风大,弹道飘,都给我贴近了再打。", "dur": 2.8, "vid": "c6_mid_laozhou_01" },
			{ "name": "曹锐", "text": "外围清得差不多了,往山门压!", "dur": 2.6, "vid": "c6_mid_caorui_01" },
		],
		"finish_lines": [
			{ "name": "曹锐", "text": "山门破了,雷达阵列就在前面!", "dur": 2.8, "vid": "c6_finish_caorui_01" },
			{ "name": "铁柱", "text": "雷达阵列报销,白狼的防空网瞎了。", "dur": 2.8, "vid": "c6_finish_tiezhu_01" },
			{ "name": "老周", "text": "指挥中心到了,白狼,该算总账了。", "dur": 2.8, "vid": "c6_finish_laozhou_01" },
		],
	})
