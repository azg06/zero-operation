...
static func build_weapons() -> Dictionary:
	...
	WD["awm"] = _w("AWM", "AWM 狙击步枪", "sniper", false, 95, 2.5, 42, 5, 30, 3.6, 0.28, 16,
	...
	WD["m24"] = _w("M24", "M24 狙击步枪", "sniper", false, 80, 2.5, 55, 5, 35, 3.1, 0.24, 18,
	...
	WD["svd"] = _w("SVD", "SVD 狙击步枪", "sniper", false, 55, 2.2, 200, 10, 50, 2.3, 0.26, 20,
